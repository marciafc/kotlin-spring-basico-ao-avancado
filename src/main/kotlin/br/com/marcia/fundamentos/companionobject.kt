...
fun main() {
    ...
    // nao precisa instanciar para chamar a criação com valores default, é um static
    var minhacLoader = MinhaClasse.criarComValoresPadrao()

    // usando como builder
    var minhacLoader2 = MinhaClasse.criarAPartirdeSegundaClasse(segundaClasse)
